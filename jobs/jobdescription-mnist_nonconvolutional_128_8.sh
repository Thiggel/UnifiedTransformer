...
#SBATCH --output=job-logs/job-('mnist', 'nonconvolutional', 128, 8).log
...
python3 main.py --dataset mnist --image-embedding nonconvolutional --embedding-dimension 128 --num-heads 8
