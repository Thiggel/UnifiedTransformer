...
#SBATCH --output=job-logs/job-('mnist', 'convolutional', 256, 2).log
...
python3 main.py --dataset mnist --image-embedding convolutional --embedding-dimension 256 --num-heads 2
