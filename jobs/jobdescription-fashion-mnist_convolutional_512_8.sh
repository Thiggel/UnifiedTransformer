...
#SBATCH --output=job-logs/job-('fashion-mnist', 'convolutional', 512, 8).log
...
python3 main.py --dataset fashion-mnist --image-embedding convolutional --embedding-dimension 512 --num-heads 8
