...
#SBATCH --output=job-logs/job-('fashion-mnist', 'non-convolutional', 256, 8).log
...
python3 main.py --dataset fashion-mnist --image-embedding non-convolutional --embedding-dimension 256 --num-heads 8
