...
#SBATCH --output=job-logs/job-('mnist', 'nonconvolutional', 256, 2).log
...
python3 main.py --dataset mnist --image-embedding nonconvolutional --embedding-dimension 256 --num-heads 2
