...
#SBATCH --output=job-logs/job-('mnist', 'convolutional', 128, 4).log
...
python3 main.py --dataset mnist --image-embedding convolutional --embedding-dimension 128 --num-heads 4
