...
#SBATCH --output=job-logs/job-('mnist', 'non-convolutional', 512, 2).log
...
python3 main.py --dataset mnist --image-embedding non-convolutional --embedding-dimension 512 --num-heads 2
