...
#SBATCH --output=job-logs/job-('fashion-mnist', 'nonconvolutional', 256, 2).log
...
python3 main.py --dataset fashion-mnist --image-embedding nonconvolutional --embedding-dimension 256 --num-heads 2
