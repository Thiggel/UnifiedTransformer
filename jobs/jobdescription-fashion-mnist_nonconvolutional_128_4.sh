...
#SBATCH --output=job-logs/job-('fashion-mnist', 'nonconvolutional', 128, 4).log
...
python3 main.py --dataset fashion-mnist --image-embedding nonconvolutional --embedding-dimension 128 --num-heads 4
