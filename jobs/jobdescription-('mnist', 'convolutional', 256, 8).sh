...
#SBATCH --output=job-logs/job-('mnist', 'convolutional', 256, 8).log
...
python3 main.py --dataset mnist --image-embedding convolutional --embedding-dimension 256 --num-heads 8
