...
#SBATCH --output=job-logs/job-('fashion-mnist', 'non-conv', 256, 4).log
...
python3 main.py --dataset fashion-mnist --image-embedding non-conv --embedding-dimension 256 --num-heads 4
