...
#SBATCH --output=job-logs/job-('fashion-mnist', 'nonconvolutional', 512, 2).log
...
python3 main.py --dataset fashion-mnist --image-embedding nonconvolutional --embedding-dimension 512 --num-heads 2
