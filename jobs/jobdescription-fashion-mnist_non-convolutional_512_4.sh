...
#SBATCH --output=job-logs/job-('fashion-mnist', 'non-convolutional', 512, 4).log
...
python3 main.py --dataset fashion-mnist --image-embedding non-convolutional --embedding-dimension 512 --num-heads 4
