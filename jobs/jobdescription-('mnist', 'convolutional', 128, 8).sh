...
#SBATCH --output=job-logs/job-('mnist', 'convolutional', 128, 8).log
...
python3 main.py --dataset mnist --image-embedding convolutional --embedding-dimension 128 --num-heads 8
