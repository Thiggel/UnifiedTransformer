...
#SBATCH --output=job-logs/job-('mnist', 'nonconvolutional', 512, 4).log
...
python3 main.py --dataset mnist --image-embedding nonconvolutional --embedding-dimension 512 --num-heads 4
