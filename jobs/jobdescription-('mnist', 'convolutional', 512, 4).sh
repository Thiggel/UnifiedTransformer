...
#SBATCH --output=job-logs/job-('mnist', 'convolutional', 512, 4).log
...
python3 main.py --dataset mnist --image-embedding convolutional --embedding-dimension 512 --num-heads 4
