...
#SBATCH --output=job-logs/job-('fashion-mnist', 'convolutional', 128, 4).log
...
python3 main.py --dataset fashion-mnist --image-embedding convolutional --embedding-dimension 128 --num-heads 4
