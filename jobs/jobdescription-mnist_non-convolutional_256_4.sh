...
#SBATCH --output=job-logs/job-('mnist', 'non-convolutional', 256, 4).log
...
python3 main.py --dataset mnist --image-embedding non-convolutional --embedding-dimension 256 --num-heads 4
