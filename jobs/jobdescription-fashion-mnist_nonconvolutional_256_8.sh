...
#SBATCH --output=job-logs/job-('fashion-mnist', 'nonconvolutional', 256, 8).log
...
python3 main.py --dataset fashion-mnist --image-embedding nonconvolutional --embedding-dimension 256 --num-heads 8
